...
public class MockData {
	...
	public static long mockTrack(Context context) {
		...
		for (Object[] mock: mockTrackPoints) {
			...
			helper.track(trackId, l, DataHelper.AZIMUTH_INVALID, 0, 0);
		}
		...
		for (Object[] mock: mockWayPoints) {
			...
			helper.wayPoint(trackId, l, (Integer) mock[5], (String) mock[6], (String) mock[7], (String) mock[8], DataHelper.AZIMUTH_INVALID, 0, 0);
		}
	...
	public static long mockBigTrack(Context context, int numWayPoints, int numTrackPoints) {
		...
		for (int i=0; i<numTrackPoints; i++) {
			...
			helper.wayPoint(trackId, l,
					...
					"wayPoint #"+i,
					"http://link.com/"+i,
					UUID.randomUUID().toString(), DataHelper.AZIMUTH_INVALID, 0, 0);
		}
